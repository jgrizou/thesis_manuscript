...
In real-world applications, users are usually told how to interact with machines. 
...
Do people want to have an open-ended choice about what signal to use? Would they be more efficient? When is it better to use a calibration procedure?
