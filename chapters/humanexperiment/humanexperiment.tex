...
\textbf{Studying the Co-Construction of Interaction Protocols in Collaborative Tasks with Humans}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.7\columnwidth]{\imgpath/setup_normal_video_one_column.png}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.49\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{\imgpath/struct1.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{\imgpath/struct2.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{\imgpath/struct3.png}
          \label{fig:sc}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{\imgpath/struct4.png}
    \end{subfigure}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth]{\imgpath/timeline_with_visu.png}
