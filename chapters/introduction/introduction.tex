...
Among others, Thomas Cederborg presented an extended reflexion on this problem in his PhD thesis \todo{cite Thomas C. thesis }  . He presents a detailed framework to describe robot social learning mechanism \cite{cederborg2013language} and propose an extended reflexion on how to relax a number of assumptions in interaction frames. 
