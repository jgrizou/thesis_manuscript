...
Endowing a robot with the ability to learn from interaction with a human requires solving several challenges: the technical challenge of motor, perceptual, and cognitive skills acquisition and generalization, as well as the practical challenge of interacting in a social way with humans.
...
The problem of learning the task requires the robot to know how to interpret user's signals. The interaction frame provides the context of the interaction, which includes some constraints about the task. In our example, our robot may know that there are only two rooms in the house. 
