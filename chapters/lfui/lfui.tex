...
Next section present results from our algorithm considering a pick and place robotic scenario where a human wants a robot to build a specific structure and provided instructions to the robot using vocal commands whose meaning are unknown to the robot at start.
