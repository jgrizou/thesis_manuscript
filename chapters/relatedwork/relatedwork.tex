...
\todo{maybe summarize the point of next subsection here: In their work, some aspects of the interaction frame are undefined, especially the teacher provide demonstration of different gestures but to not provide the association between each gesture and each task. communicate whose specificitic are}
