...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twotworldsize\columnwidth]{\visualspath/tuto_feedback/Tworld_feedback_labeled_right_left_with_gaussian.pdf}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twotworldsize\columnwidth]{\visualspath/tuto_feedback/Tworld_feedback_labeled_up_down_with_gaussian.pdf}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_agree.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_disagree.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_up_down_agree.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_up_down_disagree.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_expected_matched.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_expected_unmatched.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_unexpected_left_signal.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_unexpected_right_signal.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threetworldsize\columnwidth]{\visualspath/planning/Tworld_feedback_3hyp.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threetworldsize\columnwidth]{\visualspath/planning/Tworld_feedback_3hyp_right_left.pdf}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threetworldsize\columnwidth]{\visualspath/planning/Tworld_feedback_3hyp_up_down_no_bump.pdf}
  \caption{a}
