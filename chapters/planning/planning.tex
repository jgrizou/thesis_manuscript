...
However the question of how the robot should select its future actions will be left aside in this section. As the agent's actions are triggering the teacher signals, we can expect that learning time will be improved by having the agent seeking for more informative signals. Next section will present how our robot can plan its action to do better.
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=0.6\columnwidth]{\imgpath/planning.png}
