...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\signalwidth\columnwidth]{\visualspath/tuto_feedback/Tworld_feedback_labeled_right_left.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\signalwidth\columnwidth]{\visualspath/tuto_feedback/Tworld_feedback_labeled_up_down.png}
...
\todo{this is not allays that easy, for example if we add a third hypothesis, it is not more possible to find action whose interpretation are the same for all. But our simple example allow to understand the two principle we should consider when selecting action, finding the model and discriminating the models.}
