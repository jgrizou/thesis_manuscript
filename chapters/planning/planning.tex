...
\newcommand{\twoplanningwidth}{0.7}
\newcommand{\threeplanningwidth}{1}
\newcommand{\twotworldsize}{0.8}
\newcommand{\threetworldsize}{1}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twotworldsize\columnwidth]{\visualspath/tuto_feedback/Tworld_feedback_labeled_right_left_with_gaussian.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twotworldsize\columnwidth]{\visualspath/tuto_feedback/Tworld_feedback_labeled_up_down_with_gaussian.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_agree.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_disagree.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_up_down_agree.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\twoplanningwidth\columnwidth]{\visualspath/planning/planning_up_down_disagree.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_expected_matched.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_expected_unmatched.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_unexpected_left_signal.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threeplanningwidth\columnwidth]{\visualspath/planning/planning_right_left_unexpected_right_signal.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threetworldsize\columnwidth]{\visualspath/planning/Tworld_feedback_3hyp.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threetworldsize\columnwidth]{\visualspath/planning/Tworld_feedback_3hyp_right_left.png}
  \caption{a}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\threetworldsize\columnwidth]{\visualspath/planning/Tworld_feedback_3hyp_up_down_no_bump.png}
  \caption{a}
  \label{fig:planning3hypupdown}
\end{figure}


\todo{show 3 hyp and explain it is even worth for 624 hyp}
