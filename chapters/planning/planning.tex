...
\begin{eqnarray}
p(l = l_i| e, \theta) = \frac{p(e|\theta, l=l_i)}{\sum_k p(e|\theta, l=l_k)}
\end{eqnarray}
...
\end{eqnarray}
%
As we do not have a priori knowledge on the user intended meaning, we assume that it is equiprobable $p(z = c) = p(z = w)$. 
}
